            ...
            <div className="aboutus">
                ...
                height: "400px",
                    ...
                    <section className="dimitra-section">
                        ...
                        <h3 className="hide"  className="dimitra-bio">
                    ...
                    <section className="chen-section">
                        ...
                        <h3 className="hide" className="chen-bio">
                            CHen is a Fullstack Software Engineer and is a curious person who likes to learn new things and challenge myself.  I like to travel to different countries and meet a people with diverse background. When I am not coding, I usually spend time jogging or meditating.
                        </h3>
                    </section>
                    ...
                    <section className="elise-section">
                        ...
                        <h3 className="hide" className="elise-bio">
                            Elise is a Fullstack Software Engineer, dancer, gamer, cat mom, and costumer with a love for CSS.
                        </h3>
                    </section>
                    ...
                    <section className="scooby-section">
                        ...
                        <h3 className="hide"  className="scooby-bio">
                            Scooby is a Very Good Boi.
                        </h3>
                    </section>
